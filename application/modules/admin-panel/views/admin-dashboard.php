        ...
        <div class="admin-sub-main">
            ...
            <div class="context-box">
                <div class="inner-content-boxes">
                    <a class="link" href="<?= base_url('index.php/admin/users') ?>">
                        <div class="boxes box1">
                            <div class="amount">
                                <?php echo $total_users; ?>
                            </div>
                            <div class="amount-info">Total Users</div>
                        </div>
                    </a>
                    <a class="link" href="<?= base_url('index.php/admin/courses') ?>">
                        <div class="boxes box2">
                            <div class="amount">
                                <?php echo $total_courses; ?>
                            </div>
                            <div class="amount-info">Total Courses</div>
                        </div>
                    </a>
                    <a class="link" href="">
                        <div class="boxes box3">
                            ...
                            <div class="amount-info">Total Enrollments</div>
                        </div>
                    </a>
                </div>
...
<style>
    ...
    * {
    ...
    .box1 {
        border-bottom: 6px solid #e69b00;
    }

    .box2 {
        border-bottom: 6px solid #68bb95;
    }

    .box3 {
        border-bottom: 6px solid #d34dd2;
    }
