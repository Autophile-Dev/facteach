    ...
    <div class="page-main">
        ...
        <div class="right-part">
            <div class="internal-right">
                ...
                <div id="message"></div>
                <form class="form-right" id="register-user" method="post">
                    <!-- input 1 -->
                    <div class="form-input-contain">
                        <label class="form-input-label">Full Name</label>
                        <input id="userName" name="user_name" type="text" placeholder="John Doe" class="form-inputs">
                    ...
                    <div class="form-button-container">
                        <div class="button-form-contain">
                            <input class="form-button" type="submit" id="register-btn" name="register-btn"
                                value="Create Account">
                        </div>
                        <div class="switch-text">Already have an account? <a class="switcher"
                                href="<?= base_url('index.php/log-in') ?>">Log in</a> </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#register-user').submit(function (event) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url(); ?>index.php/form/register',
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
                    if (response.status === 'success') {
                        $('#message').html('<div class="alert-success">User registered successfully.</div>');
                        $('#userName').val('');
                        $('#userEmail').val('');
                        $('#userPassword').val('');
                    } else {
                        $('#message').html('<div class="alert-danger">User already exists with this Email. Try another Email.</div>');
                    }
                },
